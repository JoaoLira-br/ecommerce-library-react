                    ...
                    <div className="cart__item">
                      <div className="cart__book">
                        ...
                        <div className="cart__book--info">
                          ...
                          {/*(book.salePrice || book.originalPrice).toFixed(2): toFixed on the return of the boolean () which is garanteed to not be null */}
                      ...
                      <div className="cart__total">${(book.salePrice || book.originalPrice).toFixed(2) * book.quantity}</div>
                    </div>
                  );
                })}
              </div>
